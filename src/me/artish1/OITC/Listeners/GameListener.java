...
public class GameListener implements Listener {
    ...
    public void onPlayerKill(Player killer, Player player) {
        ...
        if (kills >= arena.getKillsToWin()) {
            ...
            arena.sendAll(ChatColor.GREEN + "================" + ChatColor.GRAY + "[" + ChatColor.AQUA + "OITC"
                    + ChatColor.GRAY + "]" + ChatColor.GREEN + "================");

            arena.sendAll(ChatColor.RED + killer.getName() + ChatColor.GRAY + " -(e)k irabazi du " + ChatColor.GOLD
                    + arena.getKillsToWin() + ChatColor.GRAY + " pertsona hilda" + ChatColor.AQUA + arena.getName());
            arena.sendAll(ChatColor.GREEN + "================" + ChatColor.GRAY + "[" + ChatColor.AQUA + "OITC"
                    + ChatColor.GRAY + "]" + ChatColor.GREEN + "================");
    ...
    public void onCommand(PlayerCommandPreprocessEvent e) {
        ...
        if (Arenas.isInArena(player)) {
            Arena arena = Arenas.getArena(player);
            if (arena.isOn()) {
                if (!e.getMessage().equalsIgnoreCase("/oitc") && !e.getMessage().equalsIgnoreCase("/oitc lobby")
